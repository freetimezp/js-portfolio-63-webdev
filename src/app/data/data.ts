...
export const portfolioData = [
  {
    ...
    gallery: [
      ...
      '/assets/images/portfolio/portfolio-details-2.jpg',
      '/assets/images/portfolio/portfolio-details-3.jpg',
    ],
    title: '',
    brief: '',
    category: 'graphic',
...
export const services = [
  {
    ...
    iconColor: 'blue',
    name: 'Lorem Ipsum',
    brief: `Voluptatum deleniti atque corrupti quos dolores et quas
    molestias excepturi`,
  },
  {
    id: 2,
    ...
    brief: `Duis aute irure dolor in reprehenderit in voluptate velit esse
    cillum dolore`,
  },
  {
    id: 3,
    ...
    iconColor: 'pink',
    name: 'Magni Dolores',
    brief: `Excepteur sint occaecat cupidatat non proident, sunt in culpa
    qui officia`,
  },
  {
    id: 4,
    ...
    iconColor: 'yellow',
    name: 'Nemo Enim',
    brief: `At vero eos et accusamus et iusto odio dignissimos ducimus qui
    blanditiis`,
  },
  {
    id: 5,
    ...
    iconColor: 'red',
    name: 'Dele Cardo',
    brief: `Quis consequatur saepe eligendi voluptatem consequatur dolor
    consequuntur`,
  },
  {
    id: 6,
    ...
    iconColor: 'teal',
    name: 'Divera Don',
    brief: `Modi nostrum vel laborum. Porro fugit error sit minus sapiente
    sit aspernatur`,
  },
];
    ...
    content: [
      {
        ...
        period: '2015 - 2016',
        brief: 'Rochester Institute of Technology, Rochester, NY',
        details: [
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        period: '2017 - 2018',
        brief: 'Stepping Stone Advertising, New York, NY',
        details: [
